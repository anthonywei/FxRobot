...
int INIFile::load_ini_file(const char *file,
                                char *buf,
                                int *file_size)
{
    FILE *in = NULL;
...
int INIFile::parse_file(const char *section,
                        const char *key,
                        const char *buf,
                        int *sec_s,
                        int *sec_e,
...
int INIFile::read_profile_int(const char *file,
                                const char *section,
                                const char *key,
                                int default_value)
{
...
int INIFile::read_profile_string(const char *file,
                                    const char *section,
                                    const char *key,
                                    char *value,
                                    int size,
...
int INIFile::write_profile_string(const char *file,
                                    const char *section,
                                    const char *key,
                                    const char *value)
{
